...
## Numbered candidates 481–834 (2026-08-28 — docs only; no pickup order; the tail is appended in wave order, so numbers past #656 are not sorted)
