# Planning log — August 2026

> **Class:** log · **Status:** frozen · **Reviewed:** 2026-09-26

Entries from August 2026, moved verbatim out of [planning_log.md](planning_log.md) when it rolled
over (docs_standard.md §7). Newest first within the month as originally written.
