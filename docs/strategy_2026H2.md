...
> deliberately caps volume while the learning loop needs volume to calibrate — is **still
> unresolved**, which is why this is kept. Treat specific status claims as 2026-07;
> Pillars 1–7 and the 2026-08 waves have since shipped ([roadmap.md](roadmap.md)).
