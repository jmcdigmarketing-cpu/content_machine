...
| 18 | [Kimi K3](https://openrouter.ai/moonshotai/kimi-k3) | LLM provider (Moonshot) | Frontier, 2026-07, open weights | Complement (premium) | Vision + 1M context the free tiers lack; grades/verifies, doesn't generate — see [kimi_k3_evaluation.md](kimi_k3_evaluation.md) |
